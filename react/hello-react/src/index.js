...
function getNotificationsCount(N) {
	class Notification extends Component {
		render() {
			...
			return <span>{N > 0 ? hasNotif : hasNoNotif}</span>;
		}
	}

	ReactDOM.render(<Notification />, document.getElementById('notif'));
}
...
function renderLikeButton1() {
	...
	ReactDOM.render(<Index />, document.querySelector('#likeButton1'));
}
...
function renderLikeButton2() {
	...
	ReactDOM.render(<Index />, document.querySelector('#likeButton2'));
}
...
function bindThisTest() {
	...
	ReactDOM.render(<BindThis />, document.querySelector('#bindThis'));
}
...
function renderList() {
	...
	ReactDOM.render(<Index />, document.querySelector('#list'));
}
...
function printBook() {
			...
			return (
				<div>
					{lessons.map((lesson, i) => (
						<Lesson index={i} key={i} lesson={lesson} />
					))}
				</div>
			);
		}
	...
	ReactDOM.render(<LessonsList />, document.querySelector('#print'));
}
...
function showPercentage() {
	...
	class PercentageShower extends Component {
		render() {
			return <div>{Math.round(this.props.number * 10000) / 100}%</div>;
		}
	}
	...
	ReactDOM.render(<PercentageApp />, document.querySelector('#percentage'));
}
...
function showClock() {
	...
	ReactDOM.render(<Index />, document.querySelector('#clock'));
}
